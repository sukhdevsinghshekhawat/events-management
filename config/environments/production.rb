...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "college_events_production"
  ...
  Rails.application.routes.default_url_options[:host] = 'events-management-liez.onrender.com'
  config.action_mailer.default_url_options = { host: 'events-management-liez.onrender.com', protocol: 'https' }
